...
const CardItem: FC<CardItemProps> = ({ email, showActions, onActionClick, onManage, onRemove, isLast, cardType }) => {
  return (
    <div className={`${!isLast ? 'border-b border-gray-200 pb-3' : 'pb-0'}`}>
      <div className="flex w-full items-start justify-between gap-16 pt-3">
        ...
        {cardType === 'email' && (
          <div className="relative">
            <button
              ...
              className="rounded-lg border-2 border-white p-1 transition-colors hover:border-grayMid hover:bg-grayLight"
            >
